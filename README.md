...
1. **Jugar una partida** — eliges tus números (o usas una jugada rápida al azar) y compites contra el sorteo.
2. **Simular muchos sorteos** — repite miles de sorteos y compara las probabilidades reales contra las teóricas.
3. **Ver estadísticas** — guarda tu historial de partidas en un archivo y muestra tu balance acumulado.
...
Esto confirma que el sorteo es justo y completamente aleatorio: no hay patrones
...
No necesitas instalar nada extra: solo usa Python 3 (incluido en GitHub Codespaces).
